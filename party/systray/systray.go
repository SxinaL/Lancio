...
// SetOnLeftClick sets a callback invoked when the tray icon is left-clicked.
// By default both left and right clicks show the context menu on Windows;
// after setting this callback, a left click triggers fn instead of showing the menu.
